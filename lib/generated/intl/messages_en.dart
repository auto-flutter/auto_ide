...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "autoPageAddDelayTip" : MessageLookupByLibrary.simpleMessage("Add delay (Right-click to select delay),this delay will take effect during playback"),
    ...
    "autoPageDependenciesTip" : MessageLookupByLibrary.simpleMessage("Dependencies will be automatically pre-executed (It is recommended to split the test case into multiple jump dependencies and an Auto file containing the main test logic)"),
